...
type VideoServiceClient interface {
	...
	PublishAction(ctx context.Context, in *PublishListRequest, opts ...grpc.CallOption) (*PublishListResponse, error)
...
func (c *videoServiceClient) PublishAction(ctx context.Context, in *PublishListRequest, opts ...grpc.CallOption) (*PublishListResponse, error) {
...
type VideoServiceServer interface {
	...
	PublishAction(context.Context, *PublishListRequest) (*PublishListResponse, error)
...
func (UnimplementedVideoServiceServer) PublishAction(context.Context, *PublishListRequest) (*PublishListResponse, error) {
...
func _VideoService_PublishAction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VideoServiceServer).PublishAction(ctx, req.(*PublishListRequest))
	}
	return interceptor(ctx, in, info, handler)
}

...
type User struct {
	...
	IsFollow        bool   `protobuf:"varint,5,opt,name=is_follow,json=isFollow,proto3" json:"is_follow,omitempty"`                     // 是(1)/否(0)已关注
	Avatar          string `protobuf:"bytes,6,opt,name=avatar,proto3" json:"avatar,omitempty"`                                          // 用户头像
	BackgroundImage string `protobuf:"bytes,7,opt,name=background_image,json=backgroundImage,proto3" json:"background_image,omitempty"` // 用户主页背景图
	Signature       string `protobuf:"bytes,8,opt,name=signature,proto3" json:"signature,omitempty"`                                    // 用户个人简介
...
var file_pb_user_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x74, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x40, 0x0a, 0x0f, 0x55, 0x73, 0x65,
	...
	0x01, 0x28, 0x03, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x72, 0x0a, 0x10, 0x55,
	...
	0x85, 0x01, 0x0a, 0x14, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72,
	...
	0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0xcf, 0x01, 0x0a, 0x0f, 0x55, 0x73, 0x65, 0x72,
	0x49, 0x6e, 0x66, 0x6f, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3b, 0x0a, 0x08, 0x55,
	...
	0x73, 0x65, 0x22, 0x00, 0x12, 0x43, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x11, 0x5a, 0x0f, 0x75, 0x73, 0x65,
...
var file_pb_user_proto_depIdxs = []int32{
	...
	1, // 1: user.UserInfoService.UserInfo:input_type -> user.UserInfoRequest
	3, // 2: user.UserInfoService.Login:input_type -> user.UserLoginRequest
	5, // 3: user.UserInfoService.Register:input_type -> user.UserRegisterRequest
	2, // 4: user.UserInfoService.UserInfo:output_type -> user.UserInfoResponse
	4, // 5: user.UserInfoService.Login:output_type -> user.UserLoginResponse
	6, // 6: user.UserInfoService.Register:output_type -> user.UserRegisterResponse
